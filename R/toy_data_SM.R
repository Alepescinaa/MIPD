#' Toy dataset of panel data generated under Semi-Markov assumption accounting for time spent in disease state, recording disease status
#' for each individual at each observed visit.
#'
#' @format
#' A data frame with 13,732 rows and 10 columns:
#' \describe{
